...
def rotary_embedding_mapper(tgt_pfx: str = "", src_pfx: str = "") -> ModuleMapper:
    """Creates a module mapper for rotary embeddings.

    Parameters
    ----------
    tgt_pfx : str, optional Target prefix for module mapping, by default "".
    src_pfx : str, optional Source prefix for module mapping, by default "".

    Returns
    -------
    ModuleMapper
        A configured ModuleMapper object for rotary embeddings with an added mapping for "inv_freq".
    """

    return ModuleMapper(tgt_pfx, src_pfx).add("inv_freq", "inv_freq")


def attention_mapper(tgt_pfx: str = "", src_pfx: str = "") -> ModuleMapper:
    """Creates a module mapper for attention layers.
    ...
    -------
    ModuleMapper
        A configured ModuleMapper object for attention layers.
    """
