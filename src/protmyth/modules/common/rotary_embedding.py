...
def rotate_half(x: Float[torch.Tensor, '...']) -> Float[torch.Tensor, '...']:  
...
def apply_rotary_pos_emb(x: Float[torch.Tensor, '...'], cos: Float[torch.Tensor, '...'], sin: Float[torch.Tensor, '...']) -> Float[torch.Tensor, '...']:  
...
class RotaryEmbedding(nn.Module):  
    ...
    def _update_cos_sin_tables(self, x: Float[torch.Tensor, '...'], seq_dimension: int = -2) -> Tuple[Float[torch.Tensor, '...'], Float[torch.Tensor, '...']]:  
    ...
    def forward(self, q: Float[torch.Tensor, '...'], k: Float[torch.Tensor, '...']) -> Tuple[Float[torch.Tensor, '...'], Float[torch.Tensor, '...']]:  
